...
### 5.java用（`A`）机制实现了进程之间的同步执行
+ A.监视器
+ B.虚拟机
+ C.多个CPU
+ D.异步调用

> 解答：https://www.nowcoder.com/profile/934336/myFollowings/detail/3507877
